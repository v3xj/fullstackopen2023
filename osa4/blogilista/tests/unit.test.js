...
describe('most likes', () => {
  ...
  test('when list has several blogs returns the one with most likes', () => {
...
describe('writer with most likes', () => {
  ...
  test('when list has several blogs returns the author who has most likes', () => {
